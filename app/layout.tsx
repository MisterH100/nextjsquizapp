...
export const metadata: Metadata = {
  title: "Qiuz me",
  description: "Test your iq with a wide of quizzes",
  authors:[{name:"Handsome Nyathi",url:"https://thehandsomedev.com"},{name:"misterh100",url:"https://github.com/MisterH100"}],
